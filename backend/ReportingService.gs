/**
 * Reports and CSV export. Exports never include passwords or secrets.
 */
...
var Reports = (function () {
  ...
  return { ordersReport: ordersReport, branchSummary: branchSummary, itemDemand: itemDemand, shortageReport: shortageReport, csv: csv };
})();