/**
 * Inline SVG icon set (Lucide-style, stroke-based). Keeps the app icon-
 * consistent, dependency-free and works offline from GitHub Pages.
 */
const P = {
  ...
  ghost: '<path d="M5 11V9a7 7 0 0 1 14 0v2"/><path d="M19 21a2 2 0 0 1-2-2v-3h2.4a1.6 1.6 0 0 1 1.6 1.6Z"/><path d="M5 21a2 2 0 0 0 2-2v-3H4.6a1.6 1.6 0 0 0-1.6 1.6Z"/>',
...
export function icon(name, size, className) {
  ...
  return '<svg width="' + (size || 18) + '" height="' + (size || 18) + '" viewBox="0 0 24 24" ' + ATTRS + cls + ' aria-hidden="true">' + d + '</svg>';
}
